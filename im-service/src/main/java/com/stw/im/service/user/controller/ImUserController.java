package com.stw.im.service.user.controller;
...
import com.stw.im.common.route.RouteInfo;
import com.stw.im.common.utils.RouteInfoParseUtil;
import com.stw.im.common.utils.SigAPI;
import com.stw.im.service.user.model.req.*;
import com.stw.im.service.user.service.ImUserService;
import com.stw.im.service.user.service.ImUserStatusService;
import com.stw.im.service.utils.ZKit;
...
public class ImUserController {
    ...
    public ResponseVO genUserSig(@RequestBody @Validated GenUserSigReq req) {
        long expire = req.getExpireSeconds() == null ? 60L * 60 * 24 * 7 : req.getExpireSeconds();
        SigAPI sigAPI = new SigAPI(req.getAppId().longValue(), appConfig.getPrivateKey());
        return ResponseVO.successResponse(sigAPI.genUserSig(req.getUserId(), expire));
    }
